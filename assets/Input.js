...
const Input = ({ postIcon, handleChange, handleValue, forRef, ...props }) => {
        ...
        <div className="_buildon-input-container" style={{ border: props.error === 'true' ? "1px solid #a83d3d" : null }}>
            {
                props.type === 'password'
                    ...
                    : forRef ?
                        <input {...props} value={handleValue} ref={forRef} onChange={(e) => handleChange(e.target.value)} className="_buildon-input" />
                        :
